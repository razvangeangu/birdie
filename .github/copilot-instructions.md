...
When you reply, be concise, no explanations needed as long as they are not requested. Tailor your responses to an experienced developer audience.
...
- Use @birdie/design-system components and styles wherever possible.
- Build stylesheets that support theming and responsiveness.

## Code comments

- Do not add comments for obvious code. Comments should explain why something is done, not what is being done.

## Linting

- Follow the linting rules defined in the ESLint configuration.
- Sort props alphabetically in JSX and in StyleSheet objects.
...
// App.js
<html.div style={darkTheme}>{/* All children use themed variables */}</html.div>;
```
